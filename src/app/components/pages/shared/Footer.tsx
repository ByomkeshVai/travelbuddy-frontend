const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-900 via-[#1b232b] to-gray-800">
      <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-slate-500">
        ...
        <p className="mt-8 text-xs text-slate-500">© 2022 Comany Name</p>
      </div>
    </footer>
  );
};
